              ...
              <li class="nav-item dropdown dropdown-large">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  <li>
                   ...
                   <li>
                      <a class="dropdown-item" href="hospital_list.php">
                         <div class="d-flex align-items-center">
                           <div class="setting-icon"><i class="bi bi-person-fill"></i></div>
                           <div class="setting-text ms-3"><span>Hospitals</span></div>
                         </div>
                       </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a class="dropdown-item" href="patient_list.php">
                         <div class="d-flex align-items-center">
                           <div class="setting-icon"><i class="bi bi-cloud-arrow-down-fill"></i></div>
                           <div class="setting-text ms-3"><span>Patients</span></div>
                         </div>
                       </a>
                    </li>
                    <li><hr class="dropdown-divider"></li>
        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              ...
              <ul>
                <li> <a href="patient_list.php"><i class="bi bi-arrow-right-short"></i>Patients List</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                <li> <a href="covid_report.php"><i class="bi bi-arrow-right-short"></i>Covid Reports</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                <li> <a href="vaccine_list.php"><i class="bi bi-arrow-right-short"></i>View Vaccine List</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                <li> <a href="hospital_list.php"><i class="bi bi-arrow-right-short"></i>View Hospital List</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                <li> <a href="appointment_list.php"><i class="bi bi-arrow-right-short"></i>Patient Booking Details</a>
                </li>
              </ul>
            </li>
            <li>
