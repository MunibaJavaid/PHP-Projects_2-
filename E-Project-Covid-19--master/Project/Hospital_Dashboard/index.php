            ...
            <div class="row">
                    ...
                    <div class="panel panel-white no-radius text-center">
                        <div class="panel-body">
                            ...
                            <p class="links cl-effect-1">
                                <a href="hospital_profile.php">Edit : </a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 col-lg-5">
                    <div class="panel panel-white no-radius text-center">
                        <div class="panel-body">
                            ...
                            <h2 class="StepTitle"> Appointment List </h2>

                            <p class="cl-effect-1">
                                <a href="appointment_list.php">Appointment :</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 col-lg-5">
                    <div class="panel panel-white no-radius text-center">
                        <div class="panel-body">
                            ...
                            <h2 class="StepTitle"> Vaccine List</h2>

                            <p class="links cl-effect-1">
                                <a href="book-appointment.php">
                                    <a href="Product_View.php">Vaccines :</a>
                                </a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-sm-4 col-lg-5">
                    <div class="panel panel-white no-radius text-center">
                        <div class="panel-body">
                            <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-smile-o fa-stack-1x fa-inverse"></i> </span>
                            <h2 class="StepTitle">Report List</h2>
                            <p class="links cl-effect-1">
