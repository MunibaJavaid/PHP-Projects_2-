...
(12, 1, 'Abc', '2022-12-24', '1200.00', 'Pending', 13, '1545674567867', '03350987654');
...
(5, 6, 'agha  khan', 13, 'Positive', '2022-12-22', '03350987654', '1545674567867', 'Karachi');
...
INSERT INTO `patientdetail` (`Patid`, `Name`, `Email`, `Address`, `Contact`, `Password`, `Role`) VALUES
(5, 'example', 'example@gmail.com', 'Karachi', '08877979', '$2y$10$nH8rfi02X5YzhpRrsdFcGurE1cDPDMdKfOo/SdOB4PjKi0YhIB9QW', 'P'),
(6, 'Abc', 'abc@gmail.com', 'Nazimabad no 5', '03350987654', '$2y$10$Axl3pniUCwVIvzOHkqDxl.HZ1XmgHtIZragc47L.tl3/dg03jDbyW', 'P');
...
(15, 'Xyz', '2022-12-22', '100.00', 'xyz desc', 'Available', 'agha  khan', '../Main_Layout/assets/images/g4.jpg'),
(16, 'Sinaovac', '2022-12-22', '200.00', 'Sinovac COVID-19 vaccine', 'Available', 'agha  khan', '../Main_Layout/assets/images/sinovac.jfif'),
(17, 'Sinopharm', '2022-12-22', '100.00', 'Sinopharm COVID-19 Vaccine (BBIBP-CorV)', 'Available', 'agha  khan', '../Main_Layout/assets/images/sinopharm.jfif'),
(18, 'Pfizer', '2022-12-22', '300.00', 'Pfizer-BioNTech and Moderna mRNA COVID-19 vaccines', 'Available', 'agha  khan', '../Main_Layout/assets/images/phizer.png');
...
--
ALTER TABLE `patientdetail`
  MODIFY `Patid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `vaccination`
  MODIFY `Vacid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `covid_report`
  ADD CONSTRAINT `FK_Patient_Id` FOREIGN KEY (`Patient_Id`) REFERENCES `patientdetail` (`Patid`),
