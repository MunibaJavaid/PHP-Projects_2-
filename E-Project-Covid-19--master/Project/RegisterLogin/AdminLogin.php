...
<div class="container-fluid full-bg h-100">
    <div class="container h-100 mt-5">
        <form action="AdminLogin.php" method="post" enctype="multipart/form-data" class="mt-5">
    ...
    if ($EmailCount) {
        ...
        if ($pass_decode) {
            if ($_SESSION['db_Role'] == 'A') {
                ...
                echo "<script>alert('Login Successful');window.location.href = 'AdminLogin.php'</script>";
            }
