...
<!-- <style>
 li{
	...
	<div class="hero">
		<ul class="slides">
			<li style="background-image: url('Assets/images/Banner.jpg'); height:520px;";>
			...
			<li style="background-image: url('Assets/images/Banner3.webp'); height:520px;";>
				<div class="container">
					<div class="slide-content">
			...
			<li style="background-image: url('Assets/images/Banner.jfif'); height:520px;";>
				<div class="container">
					<div class="slide-content">
			...
			<main class="main-content">
				<div class="fullwidth-block">
					<div class="container">
						<div class="row">
								...
								<div class="feature">
								<img src="Assets/images/homeappliances.jpg" style="width:300px;" alt="" class="feature-image">
									<h2 class="feature-title">HOME APPLIANCES</h2>
									<a href="Homeappliances.php" class="button">SEE PRODUCT</a>
								</div>
							</div>
							<div class="col-md-4 col-sm-6">
							<div class="feature">
									<img src="Assets/images/Wirering.jfif" style="width:300px;" alt="" class="feature-image">
									<h2 class="feature-title">WIRING</h2>
									<a href="Wiring.php" class="button">SEE PRODUCT</a>
								</div>
							</div>
							<div class="col-md-4 col-sm-6">
								<div class="feature">
									<img src="Assets/images/electrical.jfif"  style="width:300px;" class="feature-image">
									<h2 class="feature-title">ELECTRICAL PRODUCT</h2>
									<a href="Electricalproduct.php" class="button">SEE PRODUCT</a>
								</div>
							</div>
						</div> <!-- .row -->
					</div> <!-- .container -->
				...
				<div class="fullwidth-block cta"style="background-image: url('Assets/images/cover.jpg')";>
					<div class="container">
